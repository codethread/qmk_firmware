...
//        ├─────────────┼─────┼─────┼──────┼───────┼─────┤   ├─────┼───────┼─────┼─────┼─────┼──────┤
//        │ MO(_ADJUST) │     │     │ lgui │ L_NAV │ ent │   │ "_" │ L_SYM │     │     │     │      │
//        └─────────────┴─────┴─────┴──────┴───────┴─────┘   └─────┴───────┴─────┴─────┴─────┴──────┘
[_QWERTY] = LAYOUT_preonic_grid(
      ...
      MO(_ADJUST) , _______ , _______ , KC_LGUI , L_NAV , KC_ENT ,     KC_SPC , L_SYM , _______ , _______ , _______ , _______
),
...
[_SYMBOLS] = LAYOUT_preonic_grid(
      ...
      _______ , _______    , KC_ASTERISK   , KC_LBRC       , KC_RBRC        , KC_AT         ,     UPDIR    , KC_LCBR , KC_RCBR  , KC_DOLLAR , _______      , _______,
      _______ , KC_EXCLAIM , KC_EQUAL      , KC_LEFT_PAREN , KC_RIGHT_PAREN , KC_TILDE      ,     KC_MINUS , KC_LCTL , KC_LALT  , KC_LGUI   , KC_BSPC      , _______,
      _______ , _______    , KC_CIRCUMFLEX , KC_AMPR       , KC_PLUS        , KC_UNDERSCORE ,     KC_PERC  , KC_PIPE , KC_GRAVE , KC_HASH   , KC_BACKSLASH , _______,
