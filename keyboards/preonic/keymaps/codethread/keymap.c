...
[_DVORAK] = LAYOUT_preonic_grid(
  ...
  TG(_RAISE)     ,  KC_LCTL  ,  KC_LALT  ,  KC_LGUI  ,  LT(_LOWER, KC_ENT)  ,  SFT_T(KC_TAB) /* | */  ,  CTL_T(KC_BSPC)  ,  LT(_LOWER, KC_SPC)  ,  ALT_T(KC_ESC)  ,  KC_LALT  ,  KC_LCTL  ,  QWERTY
),
...
[_QWERTY] = LAYOUT_preonic_grid(
  ...
  TG(_RAISE)     ,  KC_LCTL  ,  KC_LALT  ,  KC_LGUI  ,  LT(_LOWER, KC_ENT)  ,  SFT_T(KC_TAB) /* | */  ,  CTL_T(KC_BSPC)  ,  LT(_LOWER, KC_SPC)  ,  ALT_T(KC_ESC)  ,  KC_LALT  ,  KC_LCTL  ,  DVORAK
  ),
...
[_LOWER] = LAYOUT_preonic_grid(
  ...
  _______  ,  _______     ,  KC_CIRCUMFLEX  ,  KC_AMPR        ,  KC_PLUS         ,  _______  /* | */  ,  _______   ,  KC_PIPE              ,  KC_GRAVE              ,  A(KC_3)    ,  _______       ,  _______,
