...
//        ├─────────────┼──────┼──────┼──────┼───────────────────┼──────┤   ├────────────────┼─────┼──────┼─────┼─────┼──────┤
//        │ MO(_ADJUST) │ lctl │ lalt │ lgui │ LT(_SYMBOLS, ent) │ lsft │   │ LT(_NAV, bspc) │ spc │ lalt │     │     │      │
//        └─────────────┴──────┴──────┴──────┴───────────────────┴──────┘   └────────────────┴─────┴──────┴─────┴─────┴──────┘
[_QWERTY] = LAYOUT_preonic_grid(
      ...
      MO(_ADJUST) , KC_LCTL , KC_LALT , KC_LGUI , LT(_SYMBOLS, KC_ENT) , KC_LSFT ,     LT(_NAV, KC_BSPC) , KC_SPC , KC_LALT , _______ , _______ , _______
),
...
[_SYMBOLS] = LAYOUT_preonic_grid(
      ...
      _______ , _______    , _______       , _______       , G(KC_ENT)      , _______  ,     A(KC_BSPC) , MO(_NUMBERS)        , _______              , _______   , _______      , _______
),
