...
//        ├─────────────┼─────┼─────┼──────┼───────┼─────┤   ├─────┼───────┼─────┼─────┼─────┼──────┤
//        │ MO(_ADJUST) │     │     │ lgui │ L_NAV │ ent │   │ "_" │ L_SYM │ "_" │     │     │      │
//        └─────────────┴─────┴─────┴──────┴───────┴─────┘   └─────┴───────┴─────┴─────┴─────┴──────┘
[_QWERTY] = LAYOUT_preonic_grid(
      ...
      MO(_ADJUST) , _______ , _______ , KC_LGUI , L_NAV , KC_ENT ,     KC_SPC , L_SYM , KC_SPC  , _______ , _______ , _______
),
...
[_SYMBOLS] = LAYOUT_preonic_grid(
      ...
      _______ , _______    , KC_ASTERISK   , KC_LBRC       , KC_RBRC        , KC_AT         ,     UPDIR    , KC_LCBR , KC_RCBR  , KC_DOLLAR , _______      , KC_BSPC,
      _______ , KC_EXCLAIM , KC_EQUAL      , KC_LEFT_PAREN , KC_RIGHT_PAREN , KC_TILDE      ,     KC_MINUS , KC_LCTL , KC_LALT  , KC_LGUI   , KC_BACKSLASH , KC_ENT ,
      _______ , _______    , KC_CIRCUMFLEX , KC_AMPR       , KC_PLUS        , KC_UNDERSCORE ,     KC_PERC  , KC_PIPE , KC_GRAVE , KC_HASH   , _______      , _______,
...
//        │     │     │      │  G(+)  │ G(-) │     │   │ G([) │ LSG([) │ LSG(]) │ G(]) │     │     │
//        ├─────┼─────┼──────┼────────┼──────┼─────┤   ├──────┼────────┼────────┼──────┼─────┼─────┤
//        │     │     │ lgui │  lalt  │ lctl │     │   │ left │  down  │   up   │ rght │     │     │
//        ├─────┼─────┼──────┼────────┼──────┼─────┤   ├──────┼────────┼────────┼──────┼─────┼─────┤
...
[_NAV] = LAYOUT_preonic_grid(
      ...
      _______ , _______ , KC_LGUI , KC_LALT       , KC_LCTL     , _______ ,     KC_LEFT            , KC_DOWN              , KC_UP                 , KC_RIGHT            , _______ , _______,
