...
//        ├─────────────┼─────┼─────┼──────┼───────┼──────┤   ├───────┼─────┼─────┼─────┼─────┼──────┤
//        │ MO(_ADJUST) │     │     │ lgui │ L_SYM │ lalt │   │ L_NAV │ "_" │     │     │     │      │
//        └─────────────┴─────┴─────┴──────┴───────┴──────┘   └───────┴─────┴─────┴─────┴─────┴──────┘
[_QWERTY] = LAYOUT_preonic_grid(
      ...
      MO(_ADJUST) , _______ , _______ , KC_LGUI , L_SYM , KC_LALT ,     L_NAV , KC_SPC , _______ , _______ , _______ , _______
),
...
[_SYMBOLS] = LAYOUT_preonic_grid(
      ...
      _______ , _______    , KC_LEFT_PAREN , KC_LEFT_CURLY_BRACE , KC_LEFT_BRACKET , KC_AT    ,     KC_PLUS  , KC_RIGHT_BRACKET , KC_RIGHT_CURLY_BRACE , KC_RIGHT_PAREN , _______       , _______,
      _______ , KC_EXCLAIM , KC_EQUAL      , KC_DOLLAR           , KC_ASTERISK     , KC_TILDE ,     KC_MINUS , KC_LCTL          , KC_LALT              , KC_LGUI        , KC_UNDERSCORE , _______,
      _______ , _______    , KC_CIRCUMFLEX , KC_AMPR             , KC_PERCENT      , ARROW    ,     UPDIR    , KC_PIPE          , KC_GRAVE             , KC_HASH        , KC_BACKSLASH  , _______,
...
//        │     │     │      │  G(+)  │ G(-) │     │   │ G([) │ LSG([) │ LSG(]) │ G(]) │      │     │
//        ├─────┼─────┼──────┼────────┼──────┼─────┤   ├──────┼────────┼────────┼──────┼──────┼─────┤
//        │     │     │ lgui │  lalt  │ lctl │     │   │ left │  down  │   up   │ rght │ bspc │     │
//        ├─────┼─────┼──────┼────────┼──────┼─────┤   ├──────┼────────┼────────┼──────┼──────┼─────┤
//        │     │     │      │ LSG(`) │ G(`) │     │   │ mstp │  mply  │  mnxt  │ mprv │ ent  │     │
//        ├─────┼─────┼──────┼────────┼──────┼─────┤   ├──────┼────────┼────────┼──────┼──────┼─────┤
//        │     │     │      │        │      │     │   │      │        │        │      │      │     │
//        └─────┴─────┴──────┴────────┴──────┴─────┘   └──────┴────────┴────────┴──────┴──────┴─────┘
[_NAV] = LAYOUT_preonic_grid(
      ...
      _______ , _______ , KC_LGUI , KC_LALT       , KC_LCTL     , _______ ,     KC_LEFT            , KC_DOWN              , KC_UP                 , KC_RIGHT            , KC_BSPC , _______,
      _______ , _______ , _______ , LSG(KC_GRAVE) , G(KC_GRAVE) , _______ ,     KC_MEDIA_STOP      , KC_MEDIA_PLAY_PAUSE  , KC_MEDIA_NEXT_TRACK   , KC_MEDIA_PREV_TRACK , KC_ENT  , _______,
      _______ , _______ , _______ , _______       , _______     , _______ ,     _______            , _______              , _______               , _______             , _______ , _______
),
